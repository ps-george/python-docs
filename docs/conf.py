...
# Get params from PARAMS.yml
_params_file = os.path.join(os.path.abspath('./'), 'PARAMS.yml')
if os.path.exists(_params_file):
    ...
    # Don't overwrite the values set above
    ...
    version = set_param(version, 'version')


# Get version from project/version.py
if version is None:
    VERSION = '0'
    ...
    if os.path.exists(_version_file):
        with open(_version_file, 'rb') as f:
            try:
                ...
                print("Can't read version from file.")
 
    else:
        print("{0} file not present.".format(_version_file))
    version = VERSION
